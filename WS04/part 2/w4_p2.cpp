...
int main(int argc, char** argv)
{
...

	{
		...
		seneca::Reservation* reservations[]{
								new seneca::Reservation(*ppReservations[3]),
		...
		std::cout << "==========================\n";
		seneca::Restaurant res(const_cast<const seneca::Reservation**>(reservations), 4u);
		seneca::ConfirmationSender sender;
